...
interface AddSummonState {
    isDisplayed: boolean;
    summonedCreature: CreatureViewModel;
    submitToDB: boolean;
...
export class AddSummon extends React.Component<AddSummonProps, AddSummonState> {
    ...
    constructor(props) {
        ...
        this.state = {
            isDisplayed: false,
            summonedCreature: CreatureViewModelFactory.createSummonedCreature(),
            submitToDB: false,
            howMany: 1,
        }
    }
    ...
    handleSubmit = async (event): Promise<void> => {
        ...
        this.setState({summonedCreature: CreatureViewModelFactory.createSummonedCreature()})
    };
    ...
    handleHitpointsChange = (event): void => {
        const summonedCreature = this.state.summonedCreature;
        summonedCreature.hitpoints = null;
    ...
    handleArmorClassChange = (event): void => {
        const summonedCreature = this.state.summonedCreature;
        summonedCreature.armorclass = null;
