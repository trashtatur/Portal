...
export class CreatureForm extends React.Component<CreatureFormProps, CreatureFormState> {
    ...
    constructor(props) {
        super(props);
        this.state = {
            creature: this.props.type == "edit" ? this.props.creature : CreatureViewModelFactory.createEmpty(),
            languageData: [],
            talentData: [],
            skillData: [],
            actionData: []
    ...
    addOneMoreAttackProperty = (): void => {
        ...
        creature.attackProperties.push(new AttackPropertyViewModel('',''))
        this.setState({creature: creature})
    };

    addOneMoreSkill = (): void => {
        const creature = this.state.creature;
        creature.skills.push(new SkillViewModel('','',null))
        this.setState({creature: creature})
    ...
    resetForm = (): void => {
        this.setState({creature: CreatureViewModelFactory.createEmpty()})
    };
    ...
    handleSaveThrowsChange = (event, saveThrow: "ref" | "will" | "fort"): void => {
        const creature = this.state.creature;
        creature.saveThrows[saveThrow] = null;
    ...
    handleActionsChange = (value, option): void => {
        ...
        if (option.action == SelectEventTypesEnum.SELECT_OPTION) {
            ...
            creature.actions = creature.actions.concat(actions);
                    ...
                    <form onSubmit={e => {
                        ...
                        <div className={style.formPart}>
                            ...
                            <label className={style.multiInputFormArea}>
                                ...
                                {   this.state.creature.attackProperties &&
                            ...
                            <label className={style.formTextInputArea} style={{height: '13%'}}>
                                ...
                                <div className={style.valBlockContainer}>
                                    <label className={style.singleVal}>
                                        ...
                                        <input className={style.subInput} type="number"
                                               value={this.state.creature.stats.strength}
                                               onChange={e => this.handleStatsChange(e, "str")}/>
                                    </label>
                                    <label className={style.singleVal}>
                                        dex:&nbsp;
                                        <input className={style.subInput} type="number"
                                               value={this.state.creature.stats.dexterity}
                                               onChange={e => this.handleStatsChange(e, "dex")}/>
                                    </label>
                                    <label className={style.singleVal}>
                                        con:
                                        <input className={style.subInput} type="number"
                                               value={this.state.creature.stats.constitution}
                                ...
                                <div className={style.valBlockContainer}>
                                    <label className={style.singleVal}>
                                        int:&nbsp;
                                        <input className={style.subInput} type="number"
                                               value={this.state.creature.stats.intelligence}
                                               onChange={e => this.handleStatsChange(e, "int")}/>
                                    </label>
                                    <label className={style.singleVal}>
                                        wis:&nbsp;
                                        <input className={style.subInput} type="number"
                                               value={this.state.creature.stats.wisdom}
                                               onChange={e => this.handleStatsChange(e, "wis")}/>
                                    </label>
                                    <label className={style.singleVal}>
                                        cha:&nbsp;
                                        <input className={style.subInput} type="number"
                                               value={this.state.creature.stats.charisma}
                            ...
                            <label className={style.formTextInputArea}>
                                ...
                                <div className={style.valBlockContainer}>
                                    <label className={style.singleVal}>
                                        ref:
                                        <input className={style.subInput} type="number"
                                               value={this.state.creature.saveThrows.reflex}
                                               onChange={e => this.handleSaveThrowsChange(e, "ref")}/>
                                    </label>
                                    <label className={style.singleVal}>
                                        will:
                                        <input className={style.subInput} type="number"
                                               value={this.state.creature.saveThrows.wisdom}
                                               onChange={e => this.handleSaveThrowsChange(e, "will")}/>
                                    </label>
                                    <label className={style.singleVal}>
                                        fort:
                                        <input className={style.subInput} type="number"
                                               value={this.state.creature.saveThrows.fortitude}
                            ...
                            <label className={style.formSelectContainer}>
                                ...
                                <CreatableSelect
                                    ...
                                    value={
                                        this.state.creature.languages &&
                                        this.state.creature.languages.map(elem => {
                            ...
                            <label className={style.formSelectContainer}>
                                ...
                                <CreatableSelect
                                    ...
                                    className={style.creatureFormSelect}
                                    value={
                                        this.state.creature.talents &&
                                        this.state.creature.talents.map(elem => {
                                        return ({value: elem, label: elem})
                                    })}
                                    isClearable
                                    isMulti={true}
                            ...
                            <label className={style.formSelectContainer}>
                                ...
                                <Select
                                    ...
                                    className={style.creatureFormSelect}
                                    value={
                                        this.state.creature.actions &&
                                        this.state.creature.actions.map(elem => {
                                        return ({
