...
export const calculateAverageHP = (hitDice: DiceRollSpecification): number => {
 ...
 */
export const calculateMatchingHitDice = (hpValue: number, hitDiceType: number, constitutionModifier: number): DiceRollSpecification => {
